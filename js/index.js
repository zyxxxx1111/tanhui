...
var colorList = [[
  ...
  var getlist = function(){
    ...
    $.ajax({
      ...
      url: "http://127.0.0.1:7777/doubleCarbon/get",
      ...
      success: function(res) {
          if(res.code == 200){
            for(let i = 0; i < res.data.length; i++){
              ...
              var itemStyle = { "normal": { "shadowBlur": 100, "shadowColor": colorList[i], "color":colorList[i] } };
              a.itemStyle = itemStyle;
              a.label = { "normal": { "textStyle": { "color": "#fff" } } };
              a.url = b.url;
              data[i] = a;
            }
  ...
  //   },
  //   "label": { "normal": { "textStyle": { "color": "#fff" } } },
  //   "url": "https://baike.baidu.com/item/%E7%A2%B3%E4%BA%A4%E6%98%93%E5%B8%82%E5%9C%BA?fromModule=lemma_search-box"
  // }];
  }
