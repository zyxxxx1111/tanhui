...
(function () {
  ...
  var getData = function(){
    ...
    $.ajax({
      ...
      url: "http://127.0.0.1:7777/mainEnergySource/get",
  ...
  var getLinks = function(){
    ...
    $.ajax({
      type: "GET",
      // contentType: "application/json; charset=utf-8",
      url: "http://127.0.0.1:7777/mainEnergySource/getLinks",
      // data: JSON.stringify({name:name,password:password}),
      cache: false,
      async:false,
      success: function(res) {
...
(function () {
    ...
    var getList = function(){
      ...
      $.ajax({
        type: "GET",
        // contentType: "application/json; charset=utf-8",
        url: "http://127.0.0.1:7777/cleanEnergy/get",
        // data: JSON.stringify({name:name,password:password}),
        cache: false,
        async:false,
        success: function(res) {
       ...
       grid: {
            ...
            series: [
              ...
              },
              {
                ...
                //   2289.99
                //   ]
                data: list.solarPowerGeneration,
              },
              {
                name: "风力发电",
                type: "bar",
