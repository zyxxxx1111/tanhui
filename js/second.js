  ...
  var myChart = echarts.init(document.querySelector('.ditu .tanpai'));
        ...
        option = {
            ...
            visualMap: {
              ...
              splitNumber : 8,
            //   pieces : [
            //     { gte : 6000 , color : 'rgb(1, 88, 212)' },
            //     { gt : 1000 , lte : 6000 , color : 'rgb(65,105,225)' },
            //     { gt : 500 , lte : 1000, color : 'rgb(40,122,235)' },
            //     { gt : 200, lte :500 , color : 'rgb(54, 127, 228)' },
            //     { gt : 100 , lte : 500 , color : 'rgb(95, 142, 207)' },
            //     { gt : 0 , lte : 100, color : 'rgb(54, 142, 173)' }
            // ],
              pieces : [
                { gte : 6000 , color : 'rgb(227, 82, 65)' },
                { gt : 1000 , lte : 6000 , color : 'rgb(61, 197, 231)' },
                { gt : 500 , lte : 1000, color : '#e9bae8' },
                { gt : 200, lte :500 , color : '#8bc77b' },
                { gt : 100 , lte : 500 , color : 'rgb(243, 220, 78)' },
                { gt : 0 , lte : 100, color : 'rgb(251, 180, 174)' }
            ],
            //text:'单位：百万吨',
            textStyle:{
              color:'#fff'
                ...
                // show: true, 
                // min:0,
                // max:11473,// 是否显示 visualMap-continuous 组件 如果设置为 false，不会显示，但是数据映射的功能还存在
                ...
                // // 定义 在选中范围中 的视觉元素
                // inRange: {
                //     color: ['rgb(127, 154, 192)','rgb(95, 142, 207)', '', 'rgb(54, 127, 228)', 'rgb(43, 123, 234)', 'rgb(40, 122, 235)', 'rgb(1, 88, 212)'] // 图元的颜色
                // }
            },
            series: [
                {
