...
(function () {
    ...
    var getdata = [
        [60.64,56.9,49.31,123.46,157.79,60.27,92.59],
        [77.47,78.99,86.71,169.11,251.32,64.42,133.88],
        [95.58,98.05,161.89,232.69,394.88,136.37,142.48],
        [88.98,143.93,229.16,251.8,500.6,139.12,156.55],
        [70.61,137.72,275.97,282.36,568.98,125.67,159.5]
    ]
...
const colors =  ['#3c90ff', '#fff225', 'rgb(238, 102, 102)', '#33ffbb', 'rgb(233, 191, 245)', '#ff9c3c', 'rgb(123, 104, 237)', '#ffffff', '#ffab66', '#7cff33']
const series = [
...
(function () {
  ...
  option = {
   ...
   color: ['#00a0fc', 'pink', 'rgb(227, 111, 107)', 'rgb(51, 255, 187)','rgb(123,104,238)', '#ec561b', '#ffa500', '#dddf00', '#b23aee', '#50b332'],
