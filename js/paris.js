...
(function () {
  ...
  let seriesData = [
    { name: 'Start in 2023', data: [423.32,
    384.09,
    308.68,
    232.26,
    167.65,
    ...
    { name: 'Start in 2024', data: [384.10,423.32,
      359.82,
      255.44,
      166.22,
      102.74,
    ...
    { name: 'Start in 2025', data: [308.70,359.80,423.32,
      305.56,
      163.35,
      77.38,
      34.32,
    ...
    { name: 'Start in 2026', data: [232.3,255.4,305.6,423.32,
      154.52,
      30.07,
      4.89,
      0.73,
...
(function () {
  ...
  let seriesData = [
    ...
    { name: 'Start in 2024', data: [421.9,423.32,
      421.46,
      416.33,
      408.56,
      398.67,
    ...
    { name: 'Start in 2025', data: [417.4,421.5,423.32,
      421.27,
      415.65,
      407.17,
      396.44,
    ...
    { name: 'Start in 2026', data: [410.4,416.3,421.3,423.32,
      421.06,
      414.87,
      405.58,
      393.89,
      ...
      { name: 'Start in 2027', data: [410.4,408.6,415.7,421.1,423.32,
        420.80,
        413.96,
        403.75,
        390.97,
        ...
        { name: 'Start in 2028', data: [390.7,398.7,407.2,414.9,420.8,423.32,
          420.50,
          412.89,
          401.61,
          387.60,
          ...
          { name: 'Start in 2029', data: [378.8,387.1,396.4,405.6,414.0,420.5,423.32,
            420.15,
            411.63,
            399.11,
            383.67,
